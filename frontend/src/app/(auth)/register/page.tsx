    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className="p-8 md:p-12">
          <Link href="/" className="flex items-center space-x-2">
            <motion.div whileHover={{ rotate: 15 }} transition={{ type: "spring", stiffness: 300 }}>
              <Camera className="w-6 h-6 md:w-11 md:h-11 text-spektr-cyan-50" />
            </motion.div>
      ...
      >
        <Card className="w-full max-w-md bg-[#18181b]/80 backdrop-blur-sm border-[#2c2c30] shadow-xl">
          <CardHeader>
            <CardTitle className="text-white text-2xl">Faça seu cadastro</CardTitle>
            <CardDescription className="text-gray-400">Insira seus dados para criar uma conta</CardDescription>
          </CardHeader>
          <CardContent>
            <form>
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="pt-2">
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        Cadastrar <MoveRight className="w-4 h-4" />
                      </>
                    )}
                  </Button>
                </motion.div>
          ...
          <CardFooter className="flex flex-col space-y-4 border-t border-[#2c2c30] pt-4">
            <p className="text-center text-sm text-gray-400">
              Já possui uma conta?{" "}
              <Link href="/login" className="text-spektr-cyan-50 underline hover:text-spektr-cyan-50/80 font-medium">
                Entrar
              </Link>
            </p>
          </CardFooter>
